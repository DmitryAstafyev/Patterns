(function(){var L=function(){},M=function(){},N=function(){},O=function(){},P=function(){},Q=function(){},R=function(){},S=function(){},T=function(){},U=function(){};L.prototype=function(){var u=null,e=null,r=null,q=null,p=null,l=null,d=null,t=null,n=null,h=null,g=null,m=null,b=null,c=null,k=null,C=null,H=null,F=null,u={values:{USE_STORAGE_CSS:!0,USE_STORAGE_JS:!0,USE_STORAGE_HTML:!0,PATTERN_NODE:"pattern"},validator:{USE_STORAGE_CSS:function(a){return"boolean"===typeof a?!0:!1},USE_STORAGE_JS:function(a){return"boolean"===
...
instance:{BAD_HOOK_FOR_CLONE:"2000:BAD_HOOK_FOR_CLONE",NO_URL_FOR_CLONE_HOOK:"2001:NO_URL_FOR_CLONE_HOOK"},caller:{CANNOT_INIT_PATTERN:"3000:CANNOT_INIT_PATTERN",CANNOT_GET_CHILD_PATTERN:"3001:CANNOT_GET_CHILD_PATTERN",CANNOT_GET_PATTERN:"3002:CANNOT_GET_PATTERN",PATTERN_WITHOUT_SRC:"3003:PATTERN_WITHOUT_SRC",CANNOT_FIND_ROOT_TEMPLATE:"3004:CANNOT_FIND_ROOT_TEMPLATE",ONLY_ONE_TEMPLATE_ON_SAME_LEVEL:"3005:ONLY_ONE_TEMPLATE_ON_SAME_LEVEL"},layout:{BAD_ARRAY_OF_HOOKS:"4000:BAD_ARRAY_OF_HOOKS"}},r={proto:function(a){var f=
this,d=null,k=null,x=null,n=null,Y=null,t=null,K=null,d=null,d=function(c,d){var k=null,h=null,h=null;null===a.html?(h=g.get(f.url),null!==h&&!0===u.get().USE_STORAGE_HTML?x(h,c,d):(k=b.measure(),h=flex.ajax.send(f.url,flex.ajax.methods.GET,null,{success:function(a,h){b.measure(k,"loading sources for ("+f.url+")");g.add(f.url,a);x(a,c,d)},fail:function(a,c){b.measure(k,"loading sources for ("+f.url+")");flex.logs.log(K()+m.source.FAIL_TO_LOAD_TEMPLATE,flex.logs.types.CRITICAL);t(d);throw m.source.FAIL_TO_LOAD_TEMPLATE;
...
privates:{html:a.html,pattern:null,hooks_html:null,dom:null},prototype:q.proto}).createInstanceClass():null},storage:{add:function(a,b){var c=flex.overhead.globaly.get(e.storage.VIRTUAL_STORAGE_GROUP,e.storage.PATTERNS,{});void 0===c[a]&&(c[a]=b)},get:function(a){var b=flex.overhead.globaly.get(e.storage.VIRTUAL_STORAGE_GROUP,e.storage.PATTERNS,{});return void 0!==b[a]?b[a]:null}},init:function(a,b){var c=q.storage.get(a);if(null!==c)return c;c=q.instance({url:a,html:b});return!1!==c.build()?(p.init(a,
c.pattern),q.storage.add(a,c),c):null}},p={proto:function(a){var b=this,g=null,n=null,x=null,t=null,C=null,H=null,q=null,r=null,F=null,u=flex.libraries.types.array.ExArray,q={update:function(a,b,c,f){a=a instanceof Array?void 0!==a[0]?a[0]:{}:a;var d=void 0!==c?null!==c?c:{}:{};f=void 0!==f?null!==f?f:null:null;_object(a).forEach(function(a,b){void 0===d[a]?b instanceof e.classes.RESULT?(d["__"+a+"__"]=b.url,d[a]=b.hooks_map()):"object"===typeof b&&null!==b?(d[a]={},d[a]=q.update(b,d[a].__conditions__,
d[a],null!==f?void 0!==f[a]?f[a].hooks:null:null)):null!==b&&(d[a]=!0):b instanceof e.classes.RESULT||"object"!==typeof b||(d[a]=q.update(b,d[a].__conditions__,d[a],null!==f?void 0!==f[a]?f[a].hooks:null:null))});d.__conditions__=void 0!==b?b:null;null!==f&&_object(f).forEach(function(a,b){void 0===d["__"+a+"__"]&&"object"===typeof b&&void 0!==b.url?(d["__"+a+"__"]=b.url,void 0!==b.hooks&&(d[a]=q.update(d[a],null,null,b.hooks))):void 0!==d["__"+a+"__"]&&"object"===typeof b&&void 0!==b.url&&void 0!==
b.hooks&&(d[a]=q.update(d[a],null,null,b.hooks))});return d},convertHooks:function(a,c){var k=[];c=c instanceof Array?c:[c];var g=q.update(c,a.__conditions__,a);c.forEach(function(a){var c={};_object(a).forEach(function(a,k){if(void 0!==g[a])"boolean"===typeof g[a]&&!0===g[a]?c[a]=k:"object"===typeof g[a]&&void 0!==g["__"+a+"__"]&&"object"===typeof k&&null!==k?c[a]=d.instance({url:g["__"+a+"__"],conditions:g[a].__conditions__,hooks:q.convertHooks(g[a],k)}):flex.logs.log(m.instance.NO_URL_FOR_CLONE_HOOK+
"("+b.url+")",flex.logs.types.WARNING);else throw flex.logs.log(m.instance.BAD_HOOK_FOR_CLONE+"("+b.url+")",flex.logs.types.CRITICAL),m.instance.BAD_HOOK_FOR_CLONE;});k.push(c)});return k},clone:function(a,c,k){a=q.convertHooks(a,c);if(0<a.length)return k=d.instance({url:b.url,hooks:a,callbacks:{success:"function"===typeof k?k:null}}).render(!0),k instanceof e.classes.RESULT?k.nodeList():null}},n={build:function(a){a instanceof Array?a.forEach(function(b,c){a[c]=n.build(a[c])}):null!==a&&_object(a).forEach(function(b,
c){"function"===typeof c?a[b]=c():"object"===typeof c&&null!==c&&(n.convertObj(c,a,b),delete a[b])});return a},apply:function(a,b,c,f){null!==a&&_object(b).forEach(function(b,d){var k=void 0!==f[b]?void 0!==f[b].hooks?f[b].hooks:null:null;void 0!==a[b]?(a[b]instanceof e.classes.RESULT&&(g.current["__"+b+"__"]=a[b].map().original,x.current.model["__"+b+"__"]=a[b].model(),x.current.binds["__"+b+"__"]=a[b].binds(),t.current["__"+b+"__"]=a[b].dom().original,c[b]=a[b].hooks_map(),null!==k&&(k=q.update(null,
...
null;a instanceof Array?(c=[],a.forEach(function(a){c.push(b(a))})):(c={},void 0!==a.__context&&(c.__context=p.map.create(a.__context.parentNode)),_object(a).forEach(function(a,f){"__context"!==a&&("object"===typeof f||f instanceof Array)&&(c[a]=b(f))}));return c}return{map:b(a),original:a,update:function(){this.map=g.collapse(this.original).map}}}},x={current:null,model:null,binds:null,map:function(a,b){var f=_nodes("*["+e.css.attrs.MODEL_DATA+"]",!1,a).target;0<f.length&&Array.prototype.forEach.call(f,
...
reset:function(){x.model=[];x.binds=[]},iteration:function(){x.current={model:{},binds:{}}},getLast:function(){return{model:x.model instanceof Array?x.model[x.model.length-1]:x.model,binds:x.binds instanceof Array?x.binds[x.binds.length-1]:x.binds}},getDefaults:function(a,b){var c={};_object(a).forEach(function(a,f){void 0===b[a]&&(c[a]=f)});return c},changes:{attach:function(a,b,c){a.model()instanceof Array&&(a.model(new u(a.model())),function(a,b,c){a.model().bind("add",function(f){var d=null,k=
this,g=null,d=q.clone(a.hooks_map(),f.item,function(b,c){k[f.index]=c.model;a.binds().splice(f.index,0,c.binds);a.dom().original instanceof Array&&a.dom().original.splice(f.index,0,c.dom.original[0]);a.map().original instanceof Array&&a.map().original.splice(f.index,0,c.map.original[0]);return!1});b.splice(f.index,0,d.getAsArray());1<b.length?f.index<b.length-1?(g=b[f.index+1][0],null!==g.parentNode&&d.insertBefore(g)):(g=b[0][0],null!==g.parentNode&&d.append(g.parentNode)):d.insertBefore(c)});a.model().bind("remove",
function(c){void 0!==b[c.index]&&b[c.index]instanceof Array&&b[c.index].forEach(function(a){a.parentNode.removeChild(a)});b.splice(c.index,1);a.binds().splice(c.index,1);a.dom().original instanceof Array&&a.dom().original.splice(c.index,1);a.map().original instanceof Array&&a.map().original.splice(c.index,1)})}(a,b,c))}}},t={current:null,dom:null,update:function(a){0<Object.keys(t.current).length&&_object(t.current).forEach(function(b,c){a[b]=c});t.dom.push(a)},reset:function(){t.dom=[]},iteration:function(){t.current=
{}},collapse:function(a){function b(a,c,f){function k(a,b){function c(a,b){Array.prototype.forEach.call(a,function(c,f){var k=1<a.length?b.concat([f]):b;void 0!==c[e.other.INDEXES]&&-1===d.indexOf(c)&&(d.push(c),delete c[e.other.INDEXES]);if(void 0===c[e.other.INDEXES]||c[e.other.INDEXES].length<k.length)c[e.other.INDEXES]=1<a.length?b.concat([f]):b})}a instanceof NodeList?c(a,b):a instanceof p.nodeList.NODE_LIST&&a.collections.forEach(function(a){c(a,b)})}function g(a,b,c){var f=[],d=[];if(0<a.length&&
"object"===typeof a[0]&&null!==a[0])return _object(a[0]).forEach(function(a){f.push(a)}),f.forEach(function(f){b[f]=[];a.forEach(function(a,h){a[f]instanceof NodeList||a[f]instanceof p.nodeList.NODE_LIST?(b[f].push(a[f]),k(a[f],c.concat([h]))):a[f]instanceof Array?(b[f].push({}),g(a[f],b[f][b[f].length-1],c.concat([h])),-1===d.indexOf(f)&&d.push(f)):"object"!==typeof a[f]||null===a[f]||a[f]instanceof p.nodeList.NODE_LIST||(b[f].push(a[f]),-1===d.indexOf(f)&&d.push(f))})}),d.forEach(function(a){var f=
b[a];b[a]={};g(f,b[a],c)}),_object(b).forEach(function(a,c){var f=p.nodeList.create();c instanceof Array&&(c.forEach(function(a){f.add(a)}),b[a]=f)}),b[name]}_object(a).forEach(function(a,d){d instanceof Array?(c[a]={},g(d,c[a],f)):d instanceof NodeList?(k(d,f),c[a]=p.nodeList.create(d)):"object"===typeof d&&(c[a]={},b(d,c[a],f))})}function c(a){var b=null;a instanceof Array?(b=[],a.forEach(function(a){b.push(c(a))})):a instanceof NodeList?b=p.nodeList.create(a):"object"!==typeof a||null===a||a instanceof
p.nodeList.NODE_LIST||(b={},_object(a).forEach(function(a,f){b[a]=c(f)}));return b}var f=[],d=[];null!==a&&b(a,f,[]);return{listed:c(a),grouped:f,original:a,update:function(){var b=t.collapse(a);this.grouped=b.grouped;this.listed=b.listed}}}},r={get:function(a,b){var c={};null!==b&&_object(b).forEach(function(b,f){c[b]=f(a)});return 0<Object.keys(c).length?c:null},setDefault:function(a){var c=k.storage.get(b.url);if("object"===typeof c&&null!==c){if("object"!==typeof a||null===a)a={};_object(c).forEach(function(b,
...
f[b].__included.forEach(function(b){"function"===typeof a[b]&&void 0!==f[b]&&void 0!==a[b].tracking&&f[b].__block()})}}(a,d,g,b),h.binds[k].addHandle(m),f.push(m))});else{var g=k(c);void 0!==b[d]&&_object(b[d]).forEach(function(a,c){a!==g&&void 0!==c.del&&(c.del(),b[d][a]=null,delete b[d][a])})}}),f.forEach(function(a){a()}))}},H={apply:function(a,c,d){d=h.storage.get(null!==d?[d,b.url]:b.url);null!==d&&d.forEach(function(b){C.handle(b,a,c)})}},C={build:function(c){var d=null,k=null,h=null,m=document.createTextNode(""),
e=[m],p=[];null!==c.hooks&&(g.reset(),x.reset(),t.reset(),c.conditions=r.setDefault(c.conditions),c.hooks=n.build(c.hooks),k=q.update(c.hooks,c.conditions,null,c.map),c.hooks=c.hooks instanceof Array?c.hooks:[c.hooks],c.hooks.forEach(function(b){var f=null;d=a.pattern(r.get(b,c.conditions),c.conditions);g.iteration();x.iteration();t.iteration();n.apply(b,d.setters,k,c.map);g.update(d.clone);x.update(d.clone,x.getDefaults(b,d.setters));x.clear(d.clone);t.update(d.dom);f=d.applyConditions();p.push(Array.prototype.filter.call(d.clone.childNodes,
function(){return!0}));p[p.length-1].push(document.createTextNode(""));e=e.concat(p[p.length-1]);r.tracking(c.conditions,f,b)}));h=l.instance({url:b.url,nodes:e,map:g.collapse(g.map),model:x.model,binds:x.binds,dom:t.collapse(t.dom),hooks_map:k,instance:a.__instance,handle:function(a,b){return C.handle(a,h,b)}});x.changes.attach(h,p,m);H.apply(h,c.resources,c.component);return h},handle:function(a,b,c){function f(a,b){var c="",c=b.replace(/_/gi,"");a[b]instanceof u&&void 0===a[c+"Add"]&&void 0===
a[c+"Remove"]&&(a[""+c+"Add"]=function(a){return function(){var b=void 0!==arguments[0]?arguments[0]:a.length,c=1<arguments.length?Array.prototype.slice.call(arguments,1,arguments.length):null;return null!==c?(a.splice(b,0,c),!0):!1}}(a[b]),a[c+"Remove"]=function(a){return function(b,c){a.splice(void 0!==b?b:0,void 0!==c?c:1);return!0}}(a[b]),a[c+"Length"]=function(a){return function(){return a.length}}(a[b]))}function d(a){function b(a){if(a instanceof Array||a instanceof u)return a.forEach(function(c,
...
dom:b.dom(),resources:c},k=d(g),a.call(b,k,g))},bind:function(a){return function(){return C.build(a)}}},F={build:C.build,handle:C.handle,controllers:{apply:H.apply},bind:C.bind,clone:q.clone};return{build:F.build,handle:F.handle,controllers:{apply:F.controllers.apply},bind:F.bind,clone:F.clone}},instance:function(a){return!1!==flex.oop.objects.validate(a,[{name:"url",type:"string"},{name:"pattern",type:"function"}])?_object({parent:e.classes.INSTANCE,constr:function(){this.url=flex.system.url.restore(a.url)},
privates:{pattern:a.pattern},prototype:p.proto}).createInstanceClass():null},storage:{add:function(a,b){var c=flex.overhead.globaly.get(e.storage.VIRTUAL_STORAGE_GROUP,e.storage.PATTERNS,{});void 0===c[a]&&(c[a]=b)},get:function(a){var b=flex.overhead.globaly.get(e.storage.VIRTUAL_STORAGE_GROUP,e.storage.PATTERNS,{});return void 0!==b[a]?b[a]:null}},init:function(a,b){var c=p.storage.get(a);null===c&&void 0!==b&&(c=p.instance({url:a,pattern:b}),p.storage.add(a,c));return c},nodeList:{NODE_LIST:function(a){a instanceof
NodeList?this.collections=[a]:c.isNode(a)?this.collections=[[a]]:this.collections=[]},init:function(){p.nodeList.NODE_LIST.prototype={add:function(a){a instanceof NodeList?this.collections.push(a):a instanceof p.nodeList.NODE_LIST?this.collections=this.collections.concat(a.collections):c.isNode(a)&&this.collections.push([a])},css:function(a){var b=this;"object"===typeof a&&null!==a&&_object(a).forEach(function(a,c){b.collections.forEach(function(b){Array.prototype.forEach.call(b,function(b){void 0!==
...
[];this.collections.forEach(function(c){Array.prototype.forEach.call(c,function(c){b.push(c.removeAttribute(a))})});return 1===b.length?b[0]:b},on:function(a,b){if("function"===typeof b)this.collections.forEach(function(c){Array.prototype.forEach.call(c,function(c){var d=p.nodeList.create(c);flex.events.DOM.add(c,a,function(a){b.call(d,a,c[e.other.INDEXES])})})});else throw Error("Defined [handle] is not a function");},getAsArray:function(){var a=[];this.collections.forEach(function(b){Array.prototype.forEach.call(b,
function(b){a.push(b)})});return a}}},create:function(a){return new p.nodeList.NODE_LIST(a)},addMethod:function(a,b){"string"===typeof a&&"function"===typeof b&&(void 0!==p.nodeList.NODE_LIST.prototype[a]&&flex.logs.log("Method ["+a+"] of NODE_LIST list class was overwritten.",flex.logs.types.NOTIFICATION),p.nodeList.NODE_LIST.prototype[a]=b)}},map:{MAP:function(a){if(void 0!==a&&void 0!==a.nodeType)this.context=a;else throw Error("Context [context] should be a node.");},init:function(){p.map.MAP.prototype=
{select:function(a){a=_nodes(a,!1,this.context);return null!==a.target&&0<a.target.length?1<a.target.length?a.target:a.target[0]:null}}},create:function(a){return new p.map.MAP(a)}}},l={proto:function(a){var b=null,c=b=null,d=null,c=function(b){return a.instance.clone(a.hooks_map,b)},b=function(b,c,f,d){null!==b?Array.prototype.forEach.call(b,function(b){a.nodes.forEach(function(a){d?b.parentNode.insertBefore(a,b):b.appendChild(a)});d&&b.parentNode.removeChild(b)}):null!==c&&void 0!==c.parentNode&&
...
g[u.values.PATTERN_NODE.toLowerCase()];throw Error(m.caller.CANNOT_FIND_ROOT_TEMPLATE);},addGetters:function(a){void 0!==a.hooks&&(a.hooks instanceof Array?a.hooks.forEach(function(b,c){_object(b).forEach(function(b,f){"object"!==typeof f||f instanceof Array||void 0===f.url||(a.hooks[c][b]=d.instance({url:f.url,hooks:n.addGetters(f)}))})}):"object"===typeof a.hooks&&_object(a.hooks).forEach(function(b,c){"object"!==typeof c||c instanceof Array||void 0===c.url||(a.hooks[b]=d.instance({url:c.url,hooks:n.addGetters(c)}))}));
return a.hooks},process:function(c){var k={};return(new RegExp("<\\s*"+u.values.PATTERN_NODE+"\\s{1,}src\\s*=")).test(c)?(k=n.getStructure(c),_object(a).forEach(function(a,b){-1===["hooks","__instance","pattern"].indexOf(a)&&(k[a]=b)}),k.component=b.url,n.addGetters(k),d.instance(k)):!1}},g={values:{caller:function(c){var d=p.init(c.url),k=c.hooks();if(null===d)throw flex.logs.log(h()+m.caller.CANNOT_GET_CHILD_PATTERN+"("+c.url+")",flex.logs.types.CRITICAL),flex.system.handle(a.callbacks.fail,b.url),
...
typeof b&&null!==b&&_object(b).forEach(function(a,c){b[a]=g.value(c,a)});return b},defaults:function(){function c(a,b){_object(a).forEach(function(a,f){void 0===b[a]?b[a]=f:null!==b[a]&&"object"===typeof b[a]&&c(f,b[a])})}var d=H.storage.get(b.url);null!==d&&"object"===typeof d&&c(d,a.hooks);return!0},updateMap:function(b){function c(a,b,f){return void 0===f[b]||f[b]instanceof e.classes.CALLER?!1:d.instance({url:a.url,hooks:f[b]})}a.map=0===Object.keys(a.map).length?b:a.map;_object(a.map).forEach(function(b,
f){var d=null;if(null!==a.hooks)if(a.hooks instanceof Array)try{a.hooks.forEach(function(k,g){d=c(f,b,k);a.hooks[g][b]=!1!==d?d:a.hooks[g][b];if(!1===d)throw Error("break");})}catch(k){if("break"!==k.message)throw k;}else d=c(f,b,a.hooks),a.hooks[b]=!1!==d?d:a.hooks[b]})},defaultMap:function(){var c=F.storage.get(b.url);null!==c&&"object"===typeof c&&(a.map=0===Object.keys(a.map).length?c:a.map)}},c=function(c){function d(a,b){"object"===typeof a&&_object(a).forEach(function(a,c){var f;void 0!==c.url&&
(f=flex.system.url.restore(c.url),-1===b.indexOf(f)&&b.push(f),void 0!==c.hooks&&d(c.hooks,b))})}function t(b,c,f){var k=[],h=[];g.defaultMap();"object"===typeof a.map&&(d(a.map,k),k.forEach(function(a){null===p.init(a)&&h.push(a)}));0<h.length?r.init(h,function(a){c(b.concat(a))},f):c(b)}function l(c){g.defaults();c=1===c.length?n.process(c[0].html()):null;if(null!==c)c.render(!1,b.url);else if(g.apply(),a.pattern=p.init(b.url),null!==a.pattern)a.pattern=a.pattern.build({hooks:a.hooks,resources:a.resources,
...
b.url);throw m.caller.CANNOT_INIT_PATTERN;}if("boolean"===typeof c&&c){if(g.apply(),a.pattern=p.init(b.url),null!==a.pattern&&(a.pattern=a.pattern.build({hooks:a.hooks,resources:a.resources,conditions:a.conditions,component:a.component,map:a.map}),a.pattern instanceof e.classes.RESULT))return a.pattern.handle()(a.callbacks.success,a.resources),a.pattern}else k.reset(),k.find(a.hooks),r.init(function(){var b=[];_object(a.patterns).forEach(function(a){b.push(a)});d(a.map,b);return b}(),function(a){t(a,
...
resources:a.resources,component:a.component,pattern:null},prototype:d.proto}).createInstanceClass()):null}},t={init:function(a){function b(a){var c=a.parentNode.nodeName.toLowerCase();return c!==u.values.PATTERN_NODE?"body"!==c?b(a.parentNode):!0:!1}var c=_nodes(u.values.PATTERN_NODE).target;a="boolean"===typeof a?a:!1;null!==c&&c instanceof NodeList&&0<c.length&&Array.prototype.forEach.call(c,function(c){b(c)&&((c.hasAttribute("success")||c.hasAttribute("error"))&&a||t.caller(c))})},caller:function(a,
...
function(a){"object"===typeof a&&this.target&&(a.node=this.target);return d.instance(a)});flex.callers.define.nodes("ui.patterns.append",function(){var a=[];Array.prototype.forEach.call(this.target,function(b){"object"===typeof parameters&&this.target&&(parameters.node=this.target);a.push(d.instance(parameters))});return a})}};p.nodeList.init();p.map.init();void 0!==flex.libraries&&void 0!==flex.libraries.events&&void 0!==flex.libraries.binds&&(flex.libraries.events.create(),flex.libraries.binds.create());
n={preload:r.init,get:d.instance,controller:{attach:h.attach},conditions:{attach:k.attach},hooks:{attach:H.attach},map:{attach:F.attach},classes:{NODE_LIST:{addMethod:p.nodeList.addMethod}},setup:u.setup,debug:u.debug,layout:t.init};C.init();window._controller=n.controller.attach;window._conditions=n.conditions.attach;window._hooks=n.hooks.attach;window._map=n.map.attach;t.attach();return{preload:n.preload,get:n.get,classes:{NODE_LIST:{addMethod:n.classes.NODE_LIST.addMethod}},setup:n.setup,debug:n.debug,
layout:n.layout}};N.prototype=function(){var u=null,e=null,r=null,r=null,e=function(){null===u&&(u=function(){},u.prototype=function(){function e(b){b.element=void 0!==b.element?b.element:null;b.name="string"===typeof b.name?b.name:null;b.handle="function"===typeof b.handle?b.handle:null;b.id="string"===typeof b.id?b.id:flex.unique();b.once="boolean"===typeof b.once?b.once:!1;b.touch="boolean"===typeof b.touch?b.touch:!0;b.safely="boolean"===typeof b.safely?b.safely:!1;!1===t.has(b.name)&&(b.touch=
!1);var c;return null!==b.element&&null!==b.handle&&null!==b.name&&(c=n.get(b.element,!1),null!==c&&(c=d.buildCommonHandle(b.element,b.name,c,b.touch,b.safely),c instanceof Array))?(c.push(new g(b.id,b.handle,b.once,b.touch)),b.id):null}function p(b,c,k,g,h){c=void 0!==c?c:d.fixEvent();var m=n.get(this,!0),a=null,f=flex.unique(),e=null,t=this,l=!1;g=c.type!==g?g:c.type;var p=null;if(c&&b&&k&&null!==m&&(c=d.unificationEvent(c),m[g]&&(m=m[g],m.element_id===k))){a=m.handles;try{Array.prototype.forEach.call(a,
function(a){if(a.interaction!==f){if(a.interaction=f,e=a.launch(t,c),l=!0===l?!0:!1===a.isRemoving()?!1:!0,!1===e)throw c.flex.stop(),flex.logs.log("Break event in DOM.fire; \n\r >event: "+c.type+"\n\r >handle_id"+a.id+"\n\r >element_id"+k,flex.logs.types.WARNING),"prevent";}else flex.logs.log("Unexpected behavior of handle event in DOM.fire. Attempt to call handle twice. \n\r >event: "+c.type+"\n\r >handle_id"+a.id+"\n\r >element_id"+k,flex.logs.types.LOGICAL)})}catch(q){"prevent"!==q&&(h?flex.logs.log("Unexpected error in DOM.fire; \n\r >event: "+
c.type+"\n\r >element_id"+k,flex.logs.types.CRITICAL):p=q)}finally{!1!==l&&(m.handles=a.filter(function(a){return!1===a.isWorking()&&!1!==a.isRemoving()?!1:!0}),0===m.handles.length&&(d.destroyCommonHandle(b,g),n.clear(b)))}if(null!==p)throw p;return!0}return!1}function l(b){b=function(b){b.element=void 0!==b.element?b.element:null;b.name="string"===typeof b.name?b.name:null;b.handle="function"===typeof b.handle?b.handle:null;var c;"string"===typeof b.id?c=b.id:(c=b.handle,c=void 0!==c[h.HANDLE_EVENT_ID_PROPERTY]?
c[h.HANDLE_EVENT_ID_PROPERTY]:null);b.id=c;return b}(b);var c=null,c=null;if(null!==b.element&&null!==b.name&&(null===b.id&&null!==b.handle&&void 0!==b.handle[h.HANDLE_EVENT_ID_PROPERTY]&&(b.id=b.handle[h.HANDLE_EVENT_ID_PROPERTY]),null!==b.id&&(c=n.get(b.element,!0),"object"===typeof c[b.name]))){c=c[b.name];c=c.handles;try{Array.prototype.forEach.call(c,function(c){if(c.id===b.id)throw c.toRemove(),"handle found";})}catch(k){"handle found"!==k&&flex.logs.log("Unexpected error in DOM.remove; \n\r >event: "+
b.name+"\n\r >event_id"+b.id,flex.logs.types.CRITICAL)}finally{c=c.filter(function(b){return!1===b.isWorking()&&!1!==b.isRemoving()?!1:!0}),0===c.length&&(d.destroyCommonHandle(b.element,b.name),n.clear(b.element))}}}var d=null,t=null,n=null,h={STORAGE_NAME:"FlexEventsStorage",HANDLE_EVENT_ID_PROPERTY:"FlexEventIDProrerty"},g=null,m=null,g=function(b,c,d,g,h){this.id=b;this.handle=c;this.once=d;this.touch=g;this.safely=h;this.remove=!1;this.interaction=null;this.working=!1;this.device=null};g.prototype=
...
(a.relatedTarget=null,a.fromElement=null));a.flex.target=a.target;return a}function m(a){void 0===a.which&&void 0!==a.button&&(a.flex.which=a.button&1?1:a.button&2?3:a.button&4?2:0,a.flex.button=a.button);return a}function a(a){"object"===typeof a.touches&&(1===a.touches.length&&(a=d(a,a.touches[0]),a.flex.target=a.touches[0].target,a.flex.singleTouch=!0),a.flex.touches=a.touches);return a}void 0===b.flex&&(b=c(b),b=g(b),b=h(b),b=d(b,b),b=m(b),b=a(b));return b}};t={events:{click:{touch:"touchstart"},
dblclick:{touch:"touchstart"},mousedown:{touch:"touchstart"},mouseenter:{touch:"touchenter"},mouseleave:{touch:"touchleave"},mousemove:{touch:"touchmove"},mouseover:{touch:""},mouseout:{touch:""},mouseup:{touch:"touchend"}},has:function(b){for(var c in t.events)if(c===b||"on"+c===b)return!0;return!1},getType:function(b){for(var c in t.events)if(c===b||"on"+c===b)return t.events[c].touch;return null},getOriginalType:function(b){b=b.toLowerCase();for(var c in t.events)if(t.events[c].touch===b)return c;
...
null))throw"prevent";})}catch(m){"prevent"===m?flex.logs.log("Break event in DOM.clear.fire; \n\r >event: "+c,flex.logs.types.WARNING):flex.logs.log("Fatal error event in DOM.clear.fire; \n\r >event: "+c,flex.logs.types.WARNING)}h.handles=[];d.destroyCommonHandle(b,c);n.clear(b);return!0}return!1}return null},unify:d.unificationEvent};return{add:m.add,remove:m.remove,clear:m.clear,call:m.call,unify:m.unify,extendedAdd:m._add,extendedRemove:m._remove}}(),u=new u);return u},r={init:function(){flex.callers.define.node("events.add",
function(q,p,l,d){return e().add(this.target,q,p,l,d)});flex.callers.define.node("events.remove",function(q,p,l){return e().remove(this.target,q,p,l)});flex.callers.define.node("events.call",function(q){return e().call(this.target,q)});flex.callers.define.nodes("events.add",function(q,p,l,d){Array.prototype.forEach.call(this.target,function(t){e().add(t,q,p,l,d)})});flex.callers.define.nodes("events.remove",function(q,p,l){Array.prototype.forEach.call(this.target,function(d){e().remove(d,q,p,l)})});
flex.callers.define.nodes("events.call",function(q){Array.prototype.forEach.call(this.target,function(p){e().call(p,q)})})}};r.init();r={DOMEvents:e};return{DOMEvents:r.DOMEvents}};O.prototype=function(){var u=null,e=null,r=null,q=null,p=null,l=null,d=null,t=null,l={objects:{STORAGE_PROPERTY:"flex.object.bind.storage",HANDLE_ID_PROPERTY:"flex.object.bind.handle.id"},attrs:{STORAGE_PROPERTY:"flex.attrs.bind.storage",HANDLE_ID_PROPERTY:"flex.attrs.bind.handle.id"},props:{STORAGE_PROPERTY:"flex.props.bind.storage",
HANDLE_ID_PROPERTY:"flex.props.bind.handle.id"}},d={objects:{INCORRECT_ARGUMENTS:"defined incorrect arguments or not defined at all",PROPERTY_IS_CONST:"cannot kill bind with property, because property now is constant"},support:{DEFINE_PROPERTY:"flex.binds: Current browser does not support Object.defineProperty",MUTATION_SCANNING:"flex.attrs: Current browser does not support any avaliable way to scanning mutation of attributes"}},u={storage:{create:function(d){var h=function(d){this.parent=d;this.binds=
...
this.binds[d].handles[h]&&(delete this.binds[d].handles[h],0===Object.keys(this.binds[d].handles).length)?delete this.binds[d]:null},kill:function(d){return this.binds[d]?delete this.binds[d]:null},isPropertyReady:function(d){return void 0!==this.binds[d]?!0:!1},destroy:function(){return 0===Object.keys(this.binds).length?delete this.parent[l.objects.STORAGE_PROPERTY]:!1},setter:function(d){return this.binds[d].setter},getter:function(d){return this.binds[d].getter}};return new h(d)}},bind:function(n,
h,g){var m=l.objects.STORAGE_PROPERTY,b;if(Object.defineProperty){if("object"===typeof n&&"string"===typeof h&&"function"===typeof g){b=n[h];n[m]||(n[m]=u.storage.create(n));m=n[m];if(!m.isPropertyReady(h))if(delete n[h])m.make(h,b),Object.defineProperty(n,h,{get:m.getter(h),set:m.setter(h),configurable:!0});else return m.destroy(),!1;return m.add(h,g)}throw"object.bind::"+d.objects.INCORRECT_ARGUMENTS;}},unbind:function(n,h,g){var m=l.objects.STORAGE_PROPERTY,b;if("object"===typeof n&&"string"===
typeof h&&"string"===typeof g){if(n[m]&&(m=n[m],m.isPropertyReady(h)&&(b=n[h],m.remove(h,g),!m.isPropertyReady(h))))try{return delete n[h],n[h]=b,!0}catch(c){throw"object.unbind::"+d.objects.PROPERTY_IS_CONST;}return null}throw"object.unbind::"+d.objects.INCORRECT_ARGUMENTS;},kill:function(n,h){var g=l.objects.STORAGE_PROPERTY,m;if("object"===typeof n&&"string"===typeof h){if(n[g]){m=n[h];g=n[g];try{return g.kill(h)?(delete n[h],n[h]=m,!0):!1}catch(b){throw"object.kill::"+d.objects.PROPERTY_IS_CONST;
...
c,_object(this.binds[d].handles).forEach(function(c,n){n.call(b.node,d,b.binds[d].current,b.binds[d].previous,h,c)})))},make:function(d){this.binds[d]||(this.binds[d]={handles:{},previous:null,current:this.node.getAttribute(d)})},add:function(d,h){var b=flex.unique();h[l.attrs.HANDLE_ID_PROPERTY]=b;this.binds[d].handles[b]=h;return b},remove:function(d,h){var b=null;this.binds[d]&&this.binds[d].handles[h]&&(delete this.binds[d].handles[h],0===Object.keys(this.binds[d].handles).length&&(b=delete this.binds[d],
this.destroy()));return b},kill:function(d){var h=null;this.binds[d]&&(h=delete this.binds[d],this.destroy());return h},isAttrReady:function(d){return void 0!==this.binds[d]?!0:!1},destroy:function(){return 0===Object.keys(this.binds).length?(this._destroy(),delete this.node[l.attrs.STORAGE_PROPERTY]):!1}};return new h(d)}},bind:function(n,h,g){var m=l.attrs.STORAGE_PROPERTY;if(null!==q.attach){if(void 0!==n&&"string"===typeof h&&"function"===typeof g&&n.nodeName)return n[m]||(n[m]=e.storage.create(n),
n[m].init()),m=n[m],m.isAttrReady(h)||m.make(h),m.add(h,g);throw"attrs.bind::"+d.objects.INCORRECT_ARGUMENTS;}},unbind:function(n,h,g){var m=l.attrs.STORAGE_PROPERTY;if("object"===typeof n&&"string"===typeof h&&"string"===typeof g)return n[m]&&(m=n[m],m.isAttrReady(h))?m.remove(h,g):null;throw"attrs.unbind::"+d.objects.INCORRECT_ARGUMENTS;},kill:function(n,h){var g=l.attrs.STORAGE_PROPERTY;if("object"===typeof n&&"string"===typeof h)return n[g]&&(g=n[g],g.isAttrReady(h))?g.kill(h):null;throw"attrs.unbind::"+
d.objects.INCORRECT_ARGUMENTS;}},r={storage:{create:function(d){var h=function(d){this.node=d;this.binds={};this._destroy=null};h.prototype={init:function(){this._destroy=q.attach(d,this.handle,this,{attributes:!0,childList:!0,subtree:!0,characterData:!0,attributeOldValue:!1,characterDataOldValue:!1})},prop:function(d){var h=null,b=this.node;d.split(".").forEach(function(c,d,g){void 0!==b[c]&&d<g.length-1?b=b[c]:void 0!==b[c]&&d===g.length-1&&(h={parent:b,name:c})});return h},handle:function(d,h){var b=
...
Object.keys(this.binds).length?(this._destroy(),delete this.node[l.props.STORAGE_PROPERTY]):!1}};return new h(d)}},bind:function(e,h,g){function m(b,d){var h=!1;d.split(".").forEach(function(d,k,a){void 0!==b[d]&&k<a.length-1?b=b[d]:void 0!==b[d]&&k===a.length-1&&(h=!0)});return h}var b=l.props.STORAGE_PROPERTY;if(null!==q.attach){if(void 0!==e&&"string"===typeof h&&"function"===typeof g&&void 0!==e.nodeName&&m(e,h))return e[b]||(e[b]=r.storage.create(e),e[b].init()),b=e[b],b.isPropReady(h)||b.make(h),
b.add(h,g);throw"props.bind::"+d.objects.INCORRECT_ARGUMENTS;}},unbind:function(e,h,g){var m=l.props.STORAGE_PROPERTY;if("object"===typeof e&&"string"===typeof h&&"string"===typeof g)return e[m]&&(m=e[m],m.isPropReady(h))?m.remove(h,g):null;throw"props.unbind::"+d.objects.INCORRECT_ARGUMENTS;},kill:function(e,h){var g=l.props.STORAGE_PROPERTY;if("object"===typeof e&&"string"===typeof h)return e[g]&&(g=e[g],g.isPropReady(h))?g.kill(h):null;throw"props.unbind::"+d.objects.INCORRECT_ARGUMENTS;}},q={init:function(){q.attach=
q.attach()},mutationObserver:function(d,h,g,m){var b=null,b=new (window.MutationObserver||window.WebKitMutationObserver)(function(b){b.forEach(function(b){h.call(g,b.attributeName,b)})});b.observe(d,m);return function(){b.disconnect()}},DOMAttrModified:function(d,h,g){flex.events.DOM.add(d,"DOMAttrModified",function(d){h.call(g,event.attrName,d)});return function(){}},onPropertyChange:function(d,h,g){flex.events.DOM.add(d,"propertychange",function(d){h.call(g,event.attributeName,d)});return function(){}},
attach:function(){return window.MutationObserver||window.WebKitMutationObserver?q.mutationObserver:function(){var d=document.createElement("DIV"),h=!1;flex.events.DOM.add(d,"DOMAttrModified",function(){h=!0});d.setAttribute("id","test");return h}()?q.DOMAttrModified:"onpropertychange"in document.body?q.onPropertyChange:null}},p={init:function(){flex.callers.define.object("binding.bind",function(d,h){return u.bind(this.target,d,h)});flex.callers.define.object("binding.unbind",function(d,h){return u.unbind(this.target,
d,h)});flex.callers.define.object("binding.kill",function(d){return u.kill(this.target,d)});flex.callers.define.node("bindingAttrs.bind",function(d,h){return e.bind(this.target,d,h)});flex.callers.define.node("bindingAttrs.unbind",function(d,h){return e.unbind(this.target,d,h)});flex.callers.define.node("bindingAttrs.kill",function(d){return e.kill(this.target,d)});flex.callers.define.nodes("bindingAttrs.bind",function(d,h){var g=[];SelectorClass();Array.prototype.forEach.call(this.target,function(m){g.push(e.bind(m,
d,h))});return g});flex.callers.define.nodes("bindingAttrs.unbind",function(d,h){var g=[];SelectorClass();Array.prototype.forEach.call(this.target,function(m){g.push(e.unbind(m,d,h))});return g});flex.callers.define.nodes("bindingAttrs.kill",function(d){var h=[];SelectorClass();Array.prototype.forEach.call(this.target,function(g){h.push(e.kill(g,d))});return h});flex.callers.define.node("bindingProps.bind",function(d,h){return r.bind(this.target,d,h)});flex.callers.define.node("bindingProps.unbind",
function(d,h){return r.unbind(this.target,d,h)});flex.callers.define.node("bindingProps.kill",function(d){return r.kill(this.target,d)});flex.callers.define.nodes("bindingProps.bind",function(d,h){var g=[];SelectorClass();Array.prototype.forEach.call(this.target,function(e){g.push(r.bind(e,d,h))});return g});flex.callers.define.nodes("bindingProps.unbind",function(d,h){var g=[];SelectorClass();Array.prototype.forEach.call(this.target,function(e){g.push(r.unbind(e,d,h))});return g});flex.callers.define.nodes("bindingProps.kill",
function(d){var h=[];SelectorClass();Array.prototype.forEach.call(this.target,function(g){h.push(r.kill(g,d))});return h})}},t={check:function(){if(!Object.defineProperty)throw d.support.DEFINE_PROPERTY;if(null===q.attach)throw d.support.MUTATION_SCANNING;}};q.init();p.init();t.check();return{}};Q.prototype=function(){function u(d){d=d||null;d=_nodes("*["+p.CONTAINER+(null!==d?'="'+d+'"':"")+"]:not(["+p.INITED+"])").target;null!==d&&Array.prototype.forEach.call(d,function(d){var e=d.getAttribute(p.CONTAINER);
""!==e&&null!==e||d.setAttribute(p.CONTAINER,flex.unique());d.setAttribute(p.INITED,!0)})}var e=null,r=null,q=null,p=null,l=null,p={CONTAINER:"data-flex-ui-window-focus",INITED:"data-flex-window-focus-inited",GLOBAL_GROUP:"flex-window-focus-global-group",GLOBAL_EVENT_FLAG:"flex-window-focus-global-event",GLOBAL_CURRENT:"flex-window-focus-global-current",GLOBAL_EVENT_ID:"flex-window-focus-global-event-id",FOCUSED_ZINDEX:1E3},r={attach:function(){!0!==flex.overhead.globaly.get(p.GLOBAL_GROUP,p.GLOBAL_EVENT_FLAG)&&
(flex.overhead.globaly.set(p.GLOBAL_GROUP,p.GLOBAL_EVENT_FLAG,!0),_node(window).events().add("click",function(d){q.onClick(d);return!0},p.GLOBAL_EVENT_ID))}},q={getContainer:function(d){var e;if("function"===typeof d.getAttribute&&(e=d.getAttribute(p.CONTAINER),""!==e&&null!==e))return{container:d,id:e};d=_node(d).html().find().parentByAttr({name:p.CONTAINER,value:null});return null!==d?{container:d,id:d.getAttribute(p.CONTAINER)}:null},history:{is:function(d){return flex.overhead.globaly.get(p.GLOBAL_GROUP,
p.GLOBAL_CURRENT)!==d?!1:!0},set:function(d){flex.overhead.globaly.set(p.GLOBAL_GROUP,p.GLOBAL_CURRENT,d)},get:function(){return flex.overhead.globaly.get(p.GLOBAL_GROUP,p.GLOBAL_CURRENT)},del:function(){flex.overhead.globaly.del(p.GLOBAL_GROUP,p.GLOBAL_CURRENT)}},onClick:function(d){d=q.getContainer(d.flex.target);var e=q.history.get();null!==e&&q.focus.unset(e);null!==d&&!1===q.history.is(d.id)&&q.focus.set(d.id)},focus:{zIndex:function(d,e){var l=_node("*["+p.CONTAINER+'="'+d+'"]').target;null!==
l&&(l.style.zIndex=e)},set:function(d){q.focus.zIndex(d,p.FOCUSED_ZINDEX);q.history.set(d)},unset:function(d){q.focus.zIndex(d,"");q.history.del(d)}}},l={attach:function(){flex.events.core.listen(flex.registry.events.ui.patterns.GROUP,flex.registry.events.ui.patterns.MOUNTED,function(d){d=void 0!==d.length?0<d.length?d[0].parentNode:null:null;null!==d&&null!==_node("*["+p.CONTAINER+"]:not(["+p.INITED+"])",!1,d).target&&u()})}},e={init:u};r.attach();l.attach();void 0!==flex.libraries&&void 0!==flex.libraries.events&&
void 0!==flex.libraries.html&&(flex.libraries.events.create(),flex.libraries.html.create());return{init:e.init}};T.prototype=function(){function u(e){e=e||null;e=_nodes("*["+q.CONTAINER+(null!==e?'="'+e+'"':"")+"]:not(["+q.INITED+"])").target;null!==e&&Array.prototype.forEach.call(e,function(e){var d=e.getAttribute(q.CONTAINER),t;""!==d&&null!==d&&(t=_nodes("*["+q.HOOK+'="'+d+'"]').target,null!==t&&r.attach(e,t,d));e.setAttribute(q.INITED,!0);e.setAttribute(q.STATE,"false");flex.overhead.objecty.set(e,
q.STORAGE,{maximazed:!1},!0)})}var e=null,r=e=null,q=null,q={CONTAINER:"data-flex-ui-window-maximize",HOOK:"data-flex-window-maximize-hook",INITED:"data-flex-window-maximize-inited",STATE:"data-flex-window-is-maximized",STORAGE:"flex-window-maximize-storage"},r={attach:function(e,l,d){Array.prototype.forEach.call(l,function(t,l){_node(t).events().add("click",function(h){r.onClick(h,e,d);return!0},d+"_"+l)})},onClick:function(e,l,d){e=flex.overhead.objecty.get(l,q.STORAGE,!1);null!==e&&(!1===e.maximazed?
r.actions.maximaze(l,e,d):r.actions.restore(l,e,d),setTimeout(function(){flex.events.core.fire(flex.registry.events.ui.window.maximize.GROUP,flex.registry.events.ui.window.maximize.CHANGE,{container:l,id:d})},10))},actions:{maximaze:function(e,l,d){l.maximazed=!0;l.size={position:""!==e.style.position?e.style.position:!1,width:""!==e.style.width?e.style.width:!1,height:""!==e.style.height?e.style.height:!1,left:""!==e.style.left?e.style.left:!1,top:""!==e.style.top?e.style.top:!1};e.style.position=
"fixed";e.style.width="100%";e.style.height="100%";e.style.left="0px";e.style.top="0px";e.setAttribute(q.STATE,"true");setTimeout(function(){flex.events.core.fire(flex.registry.events.ui.window.maximize.GROUP,flex.registry.events.ui.window.maximize.MAXIMIZED,{container:e,id:d})},10)},restore:function(e,l,d){l.maximazed=!1;e.style.position=!1!==l.size.position?l.size.position:"";e.style.width=!1!==l.size.width?l.size.width:"";e.style.height=!1!==l.size.height?l.size.height:"";e.style.left=!1!==l.size.left?
l.size.left:"";e.style.top=!1!==l.size.top?l.size.top:"";e.setAttribute(q.STATE,"false");setTimeout(function(){flex.events.core.fire(flex.registry.events.ui.window.maximize.GROUP,flex.registry.events.ui.window.maximize.RESTORED,{container:e,id:d})},10)},byID:{findByID:function(e){e=e||null;var l=null,d=[];return null!==e&&(l=_nodes("*["+q.CONTAINER+(null!==e?'="'+e+'"':"")+"]").target,null!==l&&0<l.length)?(Array.prototype.forEach.call(l,function(e){var l=flex.overhead.objecty.get(e,q.STORAGE,!1);
null!==l&&d.push({container:e,storage:l})}),0<d.length?d:null):null},maximaze:function(e){var l=r.actions.byID.findByID(e);null!==l&&l.forEach(function(d){r.actions.maximaze(d.container,d.storage,e)})},restore:function(e){var l=r.actions.byID.findByID(e);null!==l&&l.forEach(function(d){r.actions.restore(d.container,d.storage,e)})}}}},e={attach:function(){flex.events.core.listen(flex.registry.events.ui.patterns.GROUP,flex.registry.events.ui.patterns.MOUNTED,function(e){e=void 0!==e.length?0<e.length?
e[0].parentNode:null:null;null!==e&&null!==_node("*["+q.CONTAINER+"]:not(["+q.INITED+"])",!1,e).target&&u()})}};void 0!==flex.libraries&&void 0!==flex.libraries.events&&flex.libraries.events.create();e.attach();e={init:u,maximaze:r.actions.byID.maximaze,restore:r.actions.byID.restore};return{init:e.init,maximaze:e.maximaze,restore:e.restore}};R.prototype=function(){function u(d){d=d||null;d=_nodes("*["+l.CONTAINER+(null!==d?'="'+d+'"':"")+"]:not(["+l.INITED+"])").target;null!==d&&Array.prototype.forEach.call(d,
function(d){var e=d.getAttribute(l.CONTAINER),h;""!==e&&null!==e&&(h=_nodes("*["+l.HOOK+'="'+e+'"]').target,null!==h&&(r.attach(d,h,e),q.attach(d,e)));d.setAttribute(l.INITED,!0)})}var e=null,r=null,q=null,p=null,l=null,l={CONTAINER:"data-flex-ui-window-move-container",HOOK:"data-flex-ui-window-move-hook",INITED:"data-flex-window-move-inited",GLOBAL_GROUP:"flex-window-move",GLOBAL_EVENT_FLAG:"flex-window-move-global-event",GLOBAL_CURRENT:"flex-window-move-global-current",GLOBAL_EVENT_ID:"flex-window-move-global-event-id",
STATE_STORAGE:"flex-window-move-instance-state"},r={attach:function(d,e,l){Array.prototype.forEach.call(e,function(h){_node(h).events().add("mousedown",function(g){r.start(g,d,h,l)},l)})},start:function(d,e,n,h){var g,m,b;return!1===flex.overhead.objecty.get(e,l.STATE_STORAGE,!1,!1)?(g=_node(e).html().position().byPage(),m=_node(e.parentNode).html().scroll().position(),b=e.currentStyle&&e.currentStyle.position?e.currentStyle.position:window.getComputedStyle?window.getComputedStyle(e).position:null,
...
d.flex.pageY,n.style.left=e.posX+"px",n.style.top=e.posY+"px",e.oldX=d.flex.pageX,e.oldY=d.flex.pageY);return d.flex.stop()},stop:function(d){flex.overhead.globaly.del(l.GLOBAL_GROUP,l.GLOBAL_CURRENT)},global:{attach:function(){!0!==flex.overhead.globaly.get(l.GLOBAL_GROUP,l.GLOBAL_EVENT_FLAG)&&(flex.overhead.globaly.set(l.GLOBAL_GROUP,l.GLOBAL_EVENT_FLAG,!0),_node(window).events().add("mousemove",function(d){r.move(d)},l.GLOBAL_EVENT_ID),_node(window).events().add("mouseup",function(d){r.stop(d)},
l.GLOBAL_EVENT_ID))}}},q={attach:function(d,e){flex.events.core.listen(flex.registry.events.ui.window.maximize.GROUP,flex.registry.events.ui.window.maximize.MAXIMIZED,function(e){return q.onRefreshByParent(e.container,d,flex.registry.events.ui.window.maximize.MAXIMIZED)},l.STATE_STORAGE+e,!1);flex.events.core.listen(flex.registry.events.ui.window.maximize.GROUP,flex.registry.events.ui.window.maximize.RESTORED,function(e){return q.onRefreshByParent(e.container,d,flex.registry.events.ui.window.maximize.RESTORED)},
l.STATE_STORAGE+e,!1)},onRefreshByParent:function(d,e,n){if(d===e)switch(n){case flex.registry.events.ui.window.maximize.MAXIMIZED:flex.overhead.objecty.set(e,l.STATE_STORAGE,!0,!0);break;case flex.registry.events.ui.window.maximize.RESTORED:flex.overhead.objecty.set(e,l.STATE_STORAGE,!1,!0)}return!1}},p={attach:function(){flex.events.core.listen(flex.registry.events.ui.patterns.GROUP,flex.registry.events.ui.patterns.MOUNTED,function(d){d=void 0!==d.length?0<d.length?d[0].parentNode:null:null;null!==
d&&null!==_node("*["+l.CONTAINER+"]:not(["+l.INITED+"])",!1,d).target&&u()})}},e={init:u};r.global.attach();p.attach();void 0!==flex.libraries&&void 0!==flex.libraries.events&&void 0!==flex.libraries.html&&(flex.libraries.events.create(),flex.libraries.html.create());return{init:e.init}};S.prototype=function(){function u(d){d=d||null;d=_nodes("*["+l.CONTAINER+(null!==d?'="'+d+'"':"")+"]:not(["+l.INITED+"])").target;null!==d&&Array.prototype.forEach.call(d,function(d){var e=d.getAttribute(l.CONTAINER);
null!==e&&""!==e&&Array.prototype.forEach.call(l.HOOKS,function(h){var g=r.hooks.get(e,d,h);r.attach(d,g,h,e);p.attach(d,e)});d.setAttribute(l.INITED,!0)})}var e=null,r=null,q=null,p=null,l=null,l={CONTAINER:"data-flex-ui-window-resize-container",INITED:"data-flex-window-resize-inited",HOOK:"data-flex-window-resize-hook",HOOKS:["top","left","right","bottom","corner"],HOOKS_STYLE:{top:{node:"div",style:{position:"absolute",zIndex:1,height:"6px",width:"100%",top:"0px",left:"0px",cursor:"n-resize"}},
...
GLOBAL_GROUP:"flex-window-resize",GLOBAL_EVENT_FLAG:"flex-window-resize-global-event",GLOBAL_CURRENT:"flex-window-resize-global-current",GLOBAL_EVENT_ID:"flex-window-resize-global-event-id",STATE_STORAGE:"flex-window-resize-instance-state"},r={position:{getParent:function(d){return _node("*["+l.POSITION_PARENT+'="'+d+'"]').target}},hooks:{make:function(d,e){var n=document.createElement(l.HOOKS_STYLE[e].node),h;for(h in l.HOOKS_STYLE[e].style)n.style[h]=l.HOOKS_STYLE[e].style[h];d.appendChild(n);return n},
get:function(d,e,n){d=_nodes("*["+l.CONTAINER+'="'+d+'"]['+l.HOOK+'="'+n+'"]:not(['+l.INITED+"])").target;0===d.length&&(d=[],d.push(r.hooks.make(e,n)));return d}},attach:function(d,e,l,h){var g=r.position.getParent(h);Array.prototype.forEach.call(e,function(e){_node(e).events().add("mousedown",function(b){r.start(b,d,e,l,g,h)},h)})},start:function(d,e,n,h,g,m){var b,c,k,C;return!1===flex.overhead.objecty.get(e,l.STATE_STORAGE,!1,!1)?(b=_node(e).html().size().get(),c=_node(null!==g?g:e).html().position().byPage(),
...
function(d){r.move(d)},l.GLOBAL_EVENT_ID),_node(window).events().add("mouseup",function(d){r.stop(d)},l.GLOBAL_EVENT_ID))}}},p={attach:function(d,e){flex.events.core.listen(flex.registry.events.ui.window.maximize.GROUP,flex.registry.events.ui.window.maximize.MAXIMIZED,function(e){return p.onRefreshByParent(e.container,d,flex.registry.events.ui.window.maximize.MAXIMIZED)},l.STATE_STORAGE+e,!1);flex.events.core.listen(flex.registry.events.ui.window.maximize.GROUP,flex.registry.events.ui.window.maximize.RESTORED,
function(e){return p.onRefreshByParent(e.container,d,flex.registry.events.ui.window.maximize.RESTORED)},l.STATE_STORAGE+e,!1)},onRefreshByParent:function(d,e,n){if(d===e)switch(n){case flex.registry.events.ui.window.maximize.MAXIMIZED:flex.overhead.objecty.set(e,l.STATE_STORAGE,!0,!0);break;case flex.registry.events.ui.window.maximize.RESTORED:flex.overhead.objecty.set(e,l.STATE_STORAGE,!1,!0)}return!1}},q={attach:function(){flex.events.core.listen(flex.registry.events.ui.patterns.GROUP,flex.registry.events.ui.patterns.MOUNTED,
function(d){d=void 0!==d.length?0<d.length?d[0].parentNode:null:null;null!==d&&null!==_node("*["+l.CONTAINER+"]:not(["+l.INITED+"])",!1,d).target&&u()})}},e={init:u};r.global.attach();q.attach();void 0!==flex.libraries&&void 0!==flex.libraries.events&&void 0!==flex.libraries.html&&(flex.libraries.events.create(),flex.libraries.html.create());return{init:e.init}};P.prototype=function(){var u=null,e=null,r=null,q=null,p=null,l=r=null,d=null,t=null,n=null,h=null,g=null,g={storage:{GROUP:"flex.html",
SCROLL:"scroll",CUSTOM_STYLES:"custom.styles"},classes:{scroll:{MINIMAL_WIDTH:15,MINIMAL_HEIGHT:15}}},u={bySelector:function(){var d=function(){};d.prototype=function(){var b=null,c=null,b={data:{},get:function(c){var d=b.data;return void 0!==d[c]?d[c]:null},add:function(c,d){return b.data[c]=d},remove:function(c){var d=b.data;d[c]=null;delete d[c]},reset:function(){b.data={}}},c={first:function(b,c){return"string"===typeof b?(c||document).querySelector(b):null},all:function(b,c){return"string"===
...
c):null!==b.parentNode.getAttribute(c.name)?b.parentNode:this.parentByAttr(b.parentNode,c):null}};return new d},q=function(){var d=function(){};d.prototype={nodeByClientRectSize:function(b){var c=0,d=0;void 0!==b.getBoundingClientRect&&(b=b.getBoundingClientRect(),c=b.bottom-b.top,d=b.right-b.left);return{height:c,width:d}},nodeByOffset:function(b){var c=0,d=0;void 0!==b.offsetHeight&&(c=b.offsetHeight,d=b.offsetWidth);return{height:c,width:d}},nodeWithMargin:function(b){var c,d=this.node(b),e,h,
g,a,f,m,l,n;"string"===typeof b&&(c=u.bySelector(),b=c.first(b));null!==b&&(e=parseInt(document.defaultView.getComputedStyle(b).marginTop,10),h=parseInt(document.defaultView.getComputedStyle(b).marginBottom,10),g=parseInt(document.defaultView.getComputedStyle(b).marginRight,10),a=parseInt(document.defaultView.getComputedStyle(b).marginLeft,10),f=parseInt(document.defaultView.getComputedStyle(b).borderTopWidth,10),m=parseInt(document.defaultView.getComputedStyle(b).borderBottomWidth,10),l=parseInt(document.defaultView.getComputedStyle(b).borderRightWidth,
10),n=parseInt(document.defaultView.getComputedStyle(b).borderLeftWidth,10),null===e&&(e=0),null===h&&(h=0),null===g&&(g=0),null===a&&(a=0),null===f&&(f=0),null===m&&(m=0),null===l&&(l=0),null===n&&(n=0));return{height:d.height+e+h+f+m,width:d.width+g+a+l+n}},node:function(b){var c,d={height:0,width:0};"string"===typeof b&&(c=u.bySelector(),b=c.first(b));null!==b&&(d=this.nodeByClientRectSize(b),0===d.height&&0===d.width&&(d=this.nodeByOffset(b)));return d},window:function(){return self.innerHeight?
...
document.body.removeChild(c);b.value=d}return b.value}};return new d},r=function(){var d=function(){};d.prototype={build:function(b){function c(a,b){var c=b[a.settingup.parent]||null;"object"===typeof a.settingup&&null!==b&&null!==c&&Array.prototype.forEach.call(a.settingup.childs,function(d){b[d]&&("object"===typeof a[d].settingup?c.appendChild(b[d][a[d].settingup.parent]):c.appendChild(b[d]))})}function d(a){var b=document.createElement(a.node);null!==a.html&&(b.innerHTML=a.html);Array.prototype.forEach.call(a.attrs,
...
null,e=null,h=null,a=null,f=null,g=null;try{h=b.getBoundingClientRect(),c=h.top,e=h.left}catch(m){a=d.old(b),f=window.pageYOffset||objDocumentElement.scrollTop||objBody.scrollTop,g=window.pageXOffset||objDocumentElement.scrollLeft||objBody.scrollLeft,c=a.top-f,e=a.left-g}finally{return{top:c,left:e}}};c=function(b){var c=null;try{c=d.modern(b)}catch(e){c=d.old(b)}finally{return c}};b={byPage:b,byWindow:c};return{byPage:b.byPage,byWindow:b.byWindow}}();return new e},t=function(){var d=function(){};
d.prototype={em:function(b){b=b||document.documentElement;b=b.parentNode?b:document.documentElement;return parseFloat(getComputedStyle(b).fontSize)},rem:function(){this.em(document.documentElement)}};return new d},n={validateNode:function(d){var b;return d&&("string"===typeof d&&(b=u.bySelector(),d=b.first(d)),null!==d&&void 0!==d.parentNode)?d:null},appendChilds:function(d,b){for(var c=b.length-1;0<=c;--c)d.appendChild(b[0])}},h={init:function(){function h(){null===r&&(r=q())}function b(){null===
t&&(t=d())}function c(){null===a&&(a=l())}function g(){null===E&&(E=e())}function n(){null===V&&(V=u.fromParent())}var r=null,t=null,a=null,f=null,E=null,V=null;flex.callers.define.node("html.size.get",function(){h();return r.node(this.target)});flex.callers.define.node("html.size.getWithMargin",function(){h();return r.nodeWithMargin(this.target)});flex.callers.define.node("html.size.getByClientRectSize",function(){h();return r.nodeByClientRectSize(this.target)});flex.callers.define.node("html.size.getByOffset",
function(){h();return r.nodeByOffset(this.target)});flex.callers.define.node("html.position.byPage",function(){b();return t.byPage(this.target)});flex.callers.define.node("html.position.byWindow",function(){b();return t.byWindow(this.target)});flex.callers.define.node("html.styles.apply",function(b){c();return a.apply(this.target,b)});flex.callers.define.node("html.styles.redraw",function(){c();return a.redraw(this.target)});flex.callers.define.node("html.styles.addClass",function(b){c();return a.addClass(this.target,
b)});flex.callers.define.node("html.styles.removeClass",function(b){c();return a.removeClass(this.target,b)});flex.callers.define.node("html.scroll.position",function(){null===f&&(f=p());return f.get(this.target)});flex.callers.define.node("html.find.childByAttr",function(a,b){g();return E.childByAttr(this.target,a,b)});flex.callers.define.node("html.find.childByType",function(a){g();return E.childByType(this.target,a)});flex.callers.define.node("html.find.parentByAttr",function(a){g();return E.parentByAttr(this.target,
a)});flex.callers.define.node("html.find.node",function(a){n();return V.first(this.target,a)});flex.callers.define.node("html.find.nodes",function(a){n();return V.all(this.target,a)});flex.callers.define.nodes("html.size.get",function(){var a=[];h();Array.prototype.forEach.call(this.target,function(b){a.push(r.node(b))});return a});flex.callers.define.nodes("html.size.getWithMargin",function(){var a=[];h();Array.prototype.forEach.call(this.target,function(b){a.push(r.nodeWithMargin(b))});return a});
flex.callers.define.nodes("html.size.getByClientRectSize",function(){var a=[];h();Array.prototype.forEach.call(this.target,function(b){a.push(r.nodeByClientRectSize(b))});return a});flex.callers.define.nodes("html.size.getByOffset",function(){var a=[];h();Array.prototype.forEach.call(this.target,function(b){a.push(r.nodeByOffset(b))});return a});flex.callers.define.nodes("html.position.byPage",function(){var a=[];b();Array.prototype.forEach.call(this.target,function(b){a.push(t.byPage(b))});return a});
flex.callers.define.nodes("html.position.byWindow",function(){var a=[];b();Array.prototype.forEach.call(this.target,function(b){a.push(t.byWindow(b))});return a});flex.callers.define.nodes("html.styles.apply",function(b){var d=[];c();Array.prototype.forEach.call(this.target,function(c){d.push(a.apply(c,b))});return d});flex.callers.define.nodes("html.styles.redraw",function(){var b=[];c();Array.prototype.forEach.call(this.target,function(c){b.push(a.redraw(c))});return b});flex.callers.define.nodes("html.styles.addClass",
function(b){var d=[];c();Array.prototype.forEach.call(this.target,function(c){d.push(a.addClass(c,b))});return d});flex.callers.define.nodes("html.styles.removeClass",function(b){var d=[];c();Array.prototype.forEach.call(this.target,function(c){d.push(a.removeClass(c,b))});return d});flex.callers.define.nodes("html.scroll.position",function(){var a=[];null===f&&(f=p());Array.prototype.forEach.call(this.target,function(b){a.push(f.get(b))});return a});flex.callers.define.nodes("html.find.childByAttr",
function(a,b){var c=[];g();Array.prototype.forEach.call(this.target,function(d){c.push(E.childByAttr(d,a,b))});return c});flex.callers.define.nodes("html.find.childByType",function(a){var b=[];g();Array.prototype.forEach.call(this.target,function(c){b.push(E.childByType(c,a))});return b});flex.callers.define.nodes("html.find.parentByAttr",function(a){var b=[];g();Array.prototype.forEach.call(this.target,function(c){b.push(E.parentByAttr(c,a))});return b});flex.callers.define.nodes("html.find.node",
function(a){var b=[];n();Array.prototype.forEach.call(this.target,function(c){b.push(a.first(c,a))});return b});flex.callers.define.nodes("html.find.nodes",function(a){var b=[];n();Array.prototype.forEach.call(this.target,function(c){b.push(a.all(c,a))});return b})}};h.init();r={select:{bySelector:u.bySelector,fromParent:u.fromParent},find:e,size:q,scroll:p,builder:r,styles:l,position:d,units:t,helpers:n};return{select:{bySelector:r.select.bySelector,fromParent:r.select.fromParent},find:r.find,size:r.size,
scroll:r.scroll,builder:r.builder,styles:l,position:r.position,units:t,helpers:r.helpers}};U.prototype=function(){var u=null,u=null,u=function(e){function r(d){var e=void 0!==t[d]?d:null;if(null===e)for(var l in n)if(-1!==n[l].indexOf(d)){e=l;break}return e}function q(d){_object(t[d.type]).forEach(function(e,m){m.call(l,d)})}function p(e){void 0===l[e]&&Object.defineProperty(l,e,{configurable:!0,enumerable:!0,get:function(){return d[e]},set:function(g){d[e]=g;q({type:"set",index:e,item:g})}})}var l=
this,d=[],t={set:{},add:{},remove:{}},n={set:["update"],add:["new","push","unshift"],remove:["del","delete","shift","pop"]};Object.defineProperty(l,"bind",{configurable:!1,enumerable:!1,writable:!1,value:function(d,e,l){d=r(d);if(null!==d)if("function"===typeof e)if(l="string"===typeof l?l:flex.unique(),void 0===t[d][l])t[d][l]=e;else throw Error("0002: SAME_ID_OF_HANDLE");else throw Error("0001: HANDLE_ISNOT_FUNCTION");else throw Error("0000: WRONG_EVENT_NAME");}});Object.defineProperty(l,"unbind",
{configurable:!1,enumerable:!1,writable:!1,value:function(d,e){d=r(d);if(null!==d){if("function"===typeof e){for(var l in t[d])if(t[d][l]===e)return delete t[d][l],!0;return!1}if("string"===typeof e)return void 0!==t[d][e]?(delete t[d][e],!0):!1;throw Error("0003: HANDLE_OR_ID_SHOULD_BE");}throw Error("0000: WRONG_EVENT_NAME");}});Object.defineProperty(l,"pop",{configurable:!1,enumerable:!1,writable:!1,value:function(){if(-1<d.length){var e=d.pop();delete l[d.length];q({type:"remove",index:d.length,
item:e});return e}}});Object.defineProperty(l,"push",{configurable:!1,enumerable:!1,writable:!1,value:function(){for(var e=0,g=arguments.length;e<g;e++)d.push(arguments[e]),p(d.length-1),q({type:"add",index:d.length-1,item:arguments[e]});return d.length}});Object.defineProperty(l,"unshift",{configurable:!1,enumerable:!1,writable:!1,value:function(){for(var e=0,g=arguments.length;e<g;e++)d.splice(e,0,arguments[e]),p(d.length-1),q({type:"add",index:e,item:arguments[e]});for(;e<d.length;e++)q({type:"set",
index:e,item:d[e]});return d.length}});Object.defineProperty(l,"shift",{configurable:!1,enumerable:!1,writable:!1,value:function(){var e;if(0<d.length)return e=d.shift(),0===d.length&&delete l[0],q({type:"remove",index:0,item:e}),e}});Object.defineProperty(l,"splice",{configurable:!1,enumerable:!1,writable:!1,value:function(e,g){var m=[],b,c;e=void 0!==e?e>d.length-1?d.length:e:0;g=void 0!==g?g:d.length-e;for(c=0>e?d.length+e:e;g--;)b=d.splice(c,1)[0],m.push(b),delete l[d.length],q({type:"remove",
index:e+m.length-1,item:b});b=2;for(var k=arguments.length;b<k;b++)d.splice(c,0,arguments[b]),p(d.length-1),q({type:"add",index:c,item:arguments[b]}),c++;return m}});Object.defineProperty(l,"fill",{configurable:!1,enumerable:!1,writable:!1,value:function(e,g,l){var b=Object(d);l=void 0===l?d.length:l;var c=b.length>>>0;g=(void 0===g?0:g)>>0;g=0>g?Math.max(c+g,0):Math.min(g,c);l=void 0===l?c:l>>0;for(c=0>l?Math.max(c+l,0):Math.min(l,c);g<c;)b[g]=e,q({type:"set",index:g,item:e}),g++;return b}});Object.defineProperty(l,
"length",{configurable:!1,enumerable:!1,get:function(){return d.length},set:function(e){var g=Number(e);if(0===g%1&&0<=g)g<d.length?l.splice(g):g>d.length&&l.push.apply(l,Array(g-d.length));else throw new RangeError("0004: INVALID_LENGTH");return e}});Object.getOwnPropertyNames(Array.prototype).forEach(function(d){void 0===l[d]&&Object.defineProperty(l,d,{configurable:!1,enumerable:!1,writable:!1,value:Array.prototype[d]})});e instanceof Array&&l.push.apply(l,e)},u={ExArray:u};return{ExArray:u.ExArray}};
M.prototype=function(){var u,e,r,q,p,l,d,t,n,h,g,m,b,c,k,C,H,F,a,f,E,V,x,L,Y,M,K,N,O,P,Q,R,S,T,U,aa,ba,ca,da,ea,fa,ga,ha,ia,ja,ka,la,ma,na,oa,pa,qa,ra,sa,ta,ua,va,wa,xa,ya,za,Aa,Ba,Ca,J={},W,y={},D={},A={},Da,Ea,z={},G,I,v={},X={},w={},B={},J={settings:{CHECK_PATHS_IN_CSS:!0,SHOWN_LOGS:["CRITICAL","LOGICAL","WARNING"]},get:function(){return J.settings},set:function(a){for(var b in a)void 0!==J.settings[b]&&typeof J.settings[b]===typeof a[b]&&(J.settings[b]=a[b])}};g=/\?.*/gi;m=/(\.[\w\n]*)$/gi;b=
/[\w]*:\/\/[\w\n:\/\.]*\.js/gi;c=/[\s\t\n\r]/gi;k=/\.js$/gi;C=/\.css$/gi;W={CORE:"",CORE_URL:"",detect:function(){function a(b){b=v.url.parse(b.toLowerCase());W.CORE=b.target;W.CORE_URL=b.url;return b=b.path}var b=v.resources.js.getCurrentSRC(!0),c=null;if(null!==b)return a(b);if(""!==W.CORE&&(c=document.querySelector('script[src*="'+W.CORE+'"]'),null!==c))return a(c.src);throw Error("Cannot detect URL and PATH to core script. Setup name of manually [options.files.CORE]");}};y={settings:{DEFAULT_TIMEOUT:15E3,
DEFAULT_METHOD:"POST",methods:{POST:"POST",GET:"GET",PUT:"PUT",DELETE:"DELETE",OPTIONS:"OPTIONS"},regs:{URLENCODED:/-urlencoded/gi,JSON:/application\/json/gi},headers:{CONTENT_TYPE:"Content-Type",ACCEPT:"Accept"}},requests:{storage:{},add:function(a){var b=y.requests.storage;return void 0===b[a.settings.id]?(b[a.settings.id]=a,!0):!1},remove:function(a){var b=y.requests.storage;return void 0!==b[a.settings.id]?(b[a.settings.id]=null,delete b[a.settings.id],!0):!1},isConflict:function(a){return void 0===
y.requests.storage[a]?!1:!0}},create:function(a,b,c,d,e){var f=null;a="string"===typeof a?a:null;b="string"===typeof b?-1!==[y.settings.methods.POST,y.settings.methods.GET,y.settings.methods.PUT,y.settings.methods.DELETE,y.settings.methods.OPTIONS].indexOf(b.toUpperCase())?b.toUpperCase():y.settings.DEFAULT_METHOD:y.settings.DEFAULT_METHOD;e=y.parse.settings(e);c=y.parse.parameters(c,e);d=y.parse.callbacks(d);return null!==a?(f=function(a,b,c,d,Z){this.settings=Z;this.url=a;this.method=b;this.parameters=
c;this.callbacks=d;this.httpRequest=this.responseHeaders=this.response=this.timerID=null},f.prototype={send:function(){var a=this;try{y.requests.add(a);a.httpRequest=new XMLHttpRequest;for(var b in a.events)(function(a,b){D.DOM.add(b.httpRequest,a,function(c){return b.events[a](c,b)})})(b,a);if(null!==a.httpRequest){a.callback(a.callbacks.before);switch(a.method){case y.settings.methods.POST:a.httpRequest.open(a.method,a.url,!0);a.setHeaders(a);a.httpRequest.send(a.parameters._parameters);break;case y.settings.methods.GET:a.httpRequest.open(a.method,
...
d[a])d=d[a];else throw"NO_BY_PATH";}),e=!0}catch(f){if("NO_BY_PATH"!==f)throw f;}}return e?d:void 0},findBy:function(a,b,c,d){a="object"===typeof a?a:null;b="string"===typeof b?b:null;var e=(d="boolean"===typeof d?d:!1)?[]:null;if(null!==a&&null!==b){b=b.split(".");try{A.objects.forEach(a,function(a,f){var Z=A.objects.getByPath(f,b);if(void 0!==Z&&Z===c)if(d)e.push(f);else throw e=f,"1";})}catch(f){if("1"!==f)throw f;}}return e}},wrappers:{objects:function(){w.prototypes.add.object("forEach",function(a){return A.objects.forEach(this.target,
...
c){return A.objects.findBy(this.target,a,b,c)});w.prototypes.add.object("createInstanceClass",function(){return A.classes.create(this.target)})}}};z={storage:{data:{},get:function(){z.storage.data=v.localStorage.getJSON("flex.hash.storage","[FLEX_SYSTEM_RESURCES]");"object"===typeof z.storage.data&&null!==z.storage.data||z.storage.create();return z.storage.data},create:function(){z.storage.data={};z.storage.update()},update:function(){v.localStorage.setJSON("flex.hash.storage",z.storage.data,"[FLEX_SYSTEM_RESURCES]")}},
...
v.resources.css.settings.attr.SRC+'$="'+a+'"]');return null!==b?(v.resources.css.connect(a,function(){b.parentNode.removeChild(b);B.log("[HASHES]:: resource ["+a+"] have been updated in current session.",B.types.KERNEL_LOGS)}),!0):!1}}}};G={storage:{},get:function(a,b,c){var d=G.storage;return a in d&&b in d[a]?d[a][b]:c?G.set(a,b,c):null},set:function(a,b,c){var d=G.storage;d[a]=a in d?d[a]:{};d[a][b]=c;return d[a][b]},remove:function(a,b){var c=G.storage;return a in c&&b in c[a]?(c[a][b]=null,delete c[a][b],
...
b:void 0!==b?[b]:null;c="function"===typeof c?c:null;var d=null,e=G.get("flex.core",I.settings.COMMON_STORAGE_NAME,{});return null===a||e[a]?!1:(d=I.build(a,c),b.forEach(function(a){d.add(a)}),e[a]=d,!0)},add:function(a,b){var c=G.get("flex.core",I.settings.COMMON_STORAGE_NAME,{});return c[a]?c[a].add(b):!1},done:function(a,b,c){var d=G.get("flex.core",I.settings.COMMON_STORAGE_NAME,{});d[a]&&!1!==d[a].done(b,"boolean"===typeof c?c:!1)&&(d[a]=null,delete d[a]);return!1},isIn:function(a,b){var c=G.get("flex.core",
I.settings.COMMON_STORAGE_NAME,{});return c[a]?c[a].isIn(b):!1},isDone:function(a,b){var c=G.get("flex.core",I.settings.COMMON_STORAGE_NAME,{});return c[a]?c[a].isDone(b):!1},isReady:function(a){var b=G.get("flex.core",I.settings.COMMON_STORAGE_NAME,{});return b[a]?b[a].isReady():!0}};D={DOM:{add:function(){return"function"===typeof window.addEventListener?function(a,b,c){Array.prototype.forEach.call(b instanceof Array?b:[b],function(b){a.addEventListener(b,c,!1)})}:"function"===typeof document.attachEvent?
...
a},"boolean":function(a){this.target=a},object:function(a){this.target=a}},build:function(){for(var a in w.constructors)w.constructors[a].prototype=w.prototypes[a];return!0}};Da=J.init;a=A.objects.copy;f=A.objects.extend;E=A.objects.forEach;V=A.objects.validate;x=A.objects.isValueIn;H=A.classes.of;F=A.classes.create;Ea=X.id;N=D.DOM.add;O=D.DOM.remove;L=D.core.fire;Y=D.core.listen;M=D.core.register;K=D.core.remove;S=G.set;T=G.get;U=G.remove;P=I.open;Q=I.add;R=I.done;Ba=y.create;Ca={POST:y.settings.methods.POST,
GET:y.settings.methods.GET,PUT:y.settings.methods.PUT,DELETE:y.settings.methods.DELETE,OPTIONS:y.settings.methods.OPTIONS};ya=B.parseError;za=B.log;Aa=B.types;sa=w.callers.node;ta=w.callers.nodes;ua=w.callers.array;va=w.callers.object;wa=w.callers.string;xa=w.callers["boolean"];aa=w.prototypes.add.node;ba=w.prototypes.add.nodes;ca=w.prototypes.add.array;da=w.prototypes.add.object;ea=w.prototypes.add.string;fa=w.prototypes.add["boolean"];n=v.resources.css.connect;h=v.resources.css.adoption;l=v.resources.js.connect;
d=v.resources.js.adoption;t=v.resources.js.getCurrentSRC;ra=v.handle;q=v.convertor.UTF8.encode;p=v.convertor.UTF8.decode;e=v.convertor.BASE64.encode;r=v.convertor.BASE64.decode;ga=v.url.parse;ha=v.url.restoreFullURL;ma=v.localStorage.set;na=v.localStorage.get;oa=v.localStorage.del;pa=v.localStorage.setJSON;qa=v.localStorage.getJSON;ka=z.get;la=z.update.add;ia=J.get;ja=J.set;W.detect();w.build();A.wrappers.objects();return{init:Da,oop:{objects:{copy:a,extend:f,forEach:E,validate:V,isValueIn:x},classes:{of:H,
create:F}},unique:Ea,events:{DOM:{add:N,remove:O},core:{fire:L,listen:Y,register:M,remove:K}},overhead:{globaly:{set:S,get:T,del:U},objecty:{set:function(a,b,c,d){return"object"===typeof a&&"string"===typeof b&&void 0!==c?("object"!==typeof a.FlexObjectStorage&&(a.FlexObjectStorage={}),!1===("boolean"===typeof d?d:!0)?void 0===a.FlexObjectStorage[b]&&(a.FlexObjectStorage[b]=c):a.FlexObjectStorage[b]=c,c):null},get:function(a,b,c,d){d=void 0!==d?d:null;if("object"===typeof a&&"string"===typeof b)if("object"===
