...
binds:{}}},getLast:function(){return{model:k.model instanceof Array?k.model[k.model.length-1]:k.model,binds:k.binds instanceof Array?k.binds[k.binds.length-1]:k.binds}},getDefaults:function(a,b){var c={};_object(a).forEach(function(a,e){void 0===b[a]&&(c[a]=e)});return c},changes:{attach:function(a,b,c){a.model()instanceof Array&&(a.model(new Z(a.model())),function(a,b,c){a.model().bind("add",function(e){var d=null,f=this,g=null,d=p.clone(a.hooks_map(),e.item,function(b,c){f[e.index]=c.model;a.binds().splice(e.index,
...
h instanceof Array&&l.push.apply(l,h)},r={ExArray:r};return{ExArray:r.ExArray}};N.prototype=function(){var r,h,q,p,n,l,d,k,u,g,f,m,b,c,e,A,D,a,K,B,G,W,M,I,E,L,N,O,Z,P,Q,R,S,T,U,V,aa,ba,ca,da,ea,fa,ga,ha,ia,ja,ka,la,ma,na,oa,pa,qa,ra,sa,ta,ua,va,wa,xa,ya,za,Aa,Ba,J={},X,w={},C={},y={},Ca,Da,x={},F,H,t={},Y={},v={},z={},J={settings:{CHECK_PATHS_IN_CSS:!0,SHOWN_LOGS:["CRITICAL","LOGICAL","WARNING"]},get:function(){return J.settings},set:function(a){for(var b in a)void 0!==J.settings[b]&&typeof J.settings[b]===
typeof a[b]&&(J.settings[b]=a[b])}};f=/\?.*/gi;m=/(\.[\w\n]*)$/gi;b=/[\w]*:\/\/[\w\n:\/\.]*\.js/gi;c=/[\s\t\n\r]/gi;e=/\.js$/gi;A=/\.css$/gi;X={CORE:"",CORE_URL:"",detect:function(){function a(b){b=t.url.parse(b.toLowerCase());X.CORE=b.target;X.CORE_URL=b.url;return b=b.path}var b=t.resources.js.getCurrentSRC(!0),c=null;if(null!==b)return a(b);if(""!==X.CORE&&(c=document.querySelector('script[src*="'+X.CORE+'"]'),null!==c))return a(c.src);throw Error("Cannot detect URL and PATH to core script. Setup name of manually [options.files.CORE]");
...
d=t.resources.js.adoption;k=t.resources.js.getCurrentSRC;qa=t.handle;p=t.convertor.UTF8.encode;n=t.convertor.UTF8.decode;h=t.convertor.BASE64.encode;q=t.convertor.BASE64.decode;fa=t.url.parse;ga=t.url.restoreFullURL;la=t.localStorage.set;ma=t.localStorage.get;na=t.localStorage.del;oa=t.localStorage.setJSON;pa=t.localStorage.getJSON;ja=x.get;ka=x.update.add;ha=J.get;ia=J.set;X.detect();v.build();y.wrappers.objects();return{init:Ca,oop:{objects:{copy:K,extend:B,forEach:G,validate:W,isValueIn:M},classes:{of:D,
create:a}},unique:Da,events:{DOM:{add:O,remove:Z},core:{fire:I,listen:E,register:L,remove:N}},overhead:{globaly:{set:S,get:T,del:U},objecty:{set:function(a,b,c,d){return"object"===typeof a&&"string"===typeof b&&void 0!==c?("object"!==typeof a.FlexObjectStorage&&(a.FlexObjectStorage={}),!1===("boolean"===typeof d?d:!0)?void 0===a.FlexObjectStorage[b]&&(a.FlexObjectStorage[b]=c):a.FlexObjectStorage[b]=c,c):null},get:function(a,b,c,d){d=void 0!==d?d:null;if("object"===typeof a&&"string"===typeof b)if("object"===
